...
mock_settings.COLOR_PLAYER = "white"
...
class TestPlayerStats(unittest.TestCase):
    def test_generic_stats(self):
        ...
        print(
            f"Initial Stats: Speed={player.speed_mult}, Defense={player.defense_mult}, Cooldown={player.cooldown_mult}"
        )
        ...
        print(
            f"Final Stats: Speed={player.speed_mult}, Defense={player.defense_mult}, Cooldown={player.cooldown_mult}"
        )
        print("Test Passed!")
